...
PHASE_ROLE_OBJECTIVES: dict[tuple[PhaseType, str], str] = {
    ...
    (PhaseType.PLANNING, "Lead Architect"): (
        ...
        "confirmed topics (neither a Researcher message nor a 'Confirmed corpus "
        "coverage' block appears in your context), you have NO evidence — do NOT "
        "produce a section list. Output only: `[AWAITING_COVERAGE_DATA]` and "
        "nothing else. "
        "IMPORTANT: As soon as coverage data IS available and your previous output "
        "does not already contain the numbered section list — output the complete "
        "numbered section list as your entire output; this overrides the 'never "
        "list tasks' constraint. "
        "If your previous output already contains the outline, it is stored — do "
        "NOT rebuild it. "
