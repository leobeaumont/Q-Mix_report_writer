...
from qmix_report_writer.handcrafted_graph.phases import PhaseConfig
...
async def run_handcrafted(
    ...
    try:
        ...
        if execution_trace:
            from qmix_report_writer.utils.globals import ExecutionTrace
            from qmix_report_writer.utils.config import get_trace_path
            ExecutionTrace.instance().save_trace(str(get_trace_path("handcrafted_trace.json")))
