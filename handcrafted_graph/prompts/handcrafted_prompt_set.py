...
PHASE_ROLE_OBJECTIVES: dict[tuple[PhaseType, str], str] = {
    ...
    (PhaseType.DRAFTING, "Lead Architect"): (
        "State the current section to write and provide a one-sentence structural "
        "directive for DataAnalyst. Do not write prose yourself."
    ),
    (PhaseType.DRAFTING, "Data Analyst"): (
        ...
        "Do not re-synthesize or repeat content from sections already written in previous rounds. "
        "Only output NEW material scoped to the current LeadArchitect directive."
    ),
    ...
    (PhaseType.DRAFTING, "Collector"): (
        ...
        "in the Previous Text Production. Do not anticipate the next section. "
